...
public class CreateDiscussTask implements Runnable {
    ...
    public CreateDiscussTask(String token, long userid, int courseid, int role, String username, String coursename, Handler handler) {

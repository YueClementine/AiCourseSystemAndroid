...
import com.yuebing.aicoursesystemandroid.ui.teacher.CreateTaskActivity;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        bt_taskCommit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Thread(new CommitTaskTask(addvideo, addppt, videotitle, videopath, ppttitle, pptpath, courseid, coursename, task, title, token, handler)).start();
...
//            String data = bundle.getString("data");
    ...
    private Handler addVideoHandler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(@NonNull Message message) {
            Bundle bundle = message.getData();
            if (bundle.getString("error") != null) {
                Toast.makeText(EditTaskActivity.this, bundle.getString("error"), Toast.LENGTH_SHORT).show();
                return false;
            }
